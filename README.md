...
My personal notes from following along with this course can be found in the [my-notes](my-notes) directory.

The rest of this README is from the original course repository.
